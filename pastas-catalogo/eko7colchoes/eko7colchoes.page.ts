...
@Component({
  selector: 'app-eko7colchoes',
  templateUrl: './eko7colchoes.page.html',
  styleUrls: ['./eko7colchoes.page.scss'],
})
export class Eko7colchoesPage implements OnInit, AfterViewChecked {
  ...
  async ngOnInit() {
    console.log('Inicializando Eko7colchoesPage...');
    await this.requestNotificationPermission();
    this.catalogoService.getCatalogo('Eko7Colchoes').subscribe(catalogo => {
