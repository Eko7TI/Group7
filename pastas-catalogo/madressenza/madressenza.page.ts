...
@Component({
  selector: 'app-madressenza',
  templateUrl: './madressenza.page.html',
  styleUrls: ['./madressenza.page.scss'],
})
export class MadressenzaPage implements OnInit {
  ...
  async ngOnInit() {
    console.log('Inicializando Madressenza...');
    await this.requestNotificationPermission();
    this.catalogoService.getCatalogo('Madressenza').subscribe(catalogo => {
